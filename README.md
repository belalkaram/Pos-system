# Smart Accountant POS

Smart Accountant POS is a desktop point-of-sale, inventory, treasury, and reporting application built with Electron, React, TypeScript, and SQLite. The codebase is structured as an offline-first local desktop system with a React UI, Electron IPC bridge, SQLite persistence, and localStorage fallback for a number of secondary modules.
