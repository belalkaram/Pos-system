...
import {
    ...
    Warehouse, Order, Purchase, TreasuryTransaction, AttendanceRecord, Table, StockMovement
} from './types';
...
export const SEED_ORDERS: Order[] = [
    ...
    { id: 'ord-004', items: [{ ...SEED_MENU[1], quantity: 3, selectedAddons: [], totalItemPrice: 105 }, { ...SEED_MENU[11], quantity: 2, selectedAddons: [], totalItemPrice: 70 }], subtotal: 175, discount: 15, tax: 22.4, serviceCharge: 19.2, total: 201.6, paymentMethod: 'credit', customerId: 'cust-002', type: 'delivery', status: 'completed', createdAt: `${yesterday}T11:00:00`, completedAt: `${yesterday}T11:45:00`, performedBy: { name: 'محمد أحمد', role: 'cashier' } },
    { id: 'ord-005', items: [{ ...SEED_MENU[9], quantity: 1, selectedAddons: [], totalItemPrice: 85 }, { ...SEED_MENU[10], quantity: 1, selectedAddons: [], totalItemPrice: 25 }], subtotal: 110, discount: 0, tax: 15.4, serviceCharge: 13.2, total: 138.6, paymentMethod: 'cash', amountReceived: 150, changeAmount: 11.4, type: 'dine-in', tableId: 'table-003', status: 'completed', createdAt: `${yesterday}T19:30:00`, completedAt: `${yesterday}T20:15:00`, performedBy: { name: 'خالد عبدالله', role: 'cashier' } },
    { id: 'ord-006', items: [{ ...SEED_MENU[2], quantity: 4, selectedAddons: [], totalItemPrice: 128 }], subtotal: 128, discount: 0, tax: 17.92, serviceCharge: 15.36, total: 161.28, paymentMethod: 'card', type: 'takeaway', status: 'completed', createdAt: `${twoDaysAgo}T10:00:00`, completedAt: `${twoDaysAgo}T10:15:00`, performedBy: { name: 'محمد أحمد', role: 'cashier' } },
];
