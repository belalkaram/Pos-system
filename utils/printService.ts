    ...
    <body>
      <div class="print-container">
        ...
        <div class="print-footer">
          <p>${footerNote || 'Smart Gourmet POS System'} © ${new Date().getFullYear()}</p>
        </div>
      </div>
    ...
    <body>
      ...
      <div class="invoice-info">
        ...
        <div class="invoice-info-group">
          ...
          <p>نوع الخدمة: ${order.type === 'dine-in' ? 'داخل المطعم' : order.type === 'takeaway' ? 'تيك أواي' : 'توصيل'}</p>
          <p>طريقة الدفع: ${order.paymentMethod === 'cash' ? 'نقداً' : order.paymentMethod === 'card' ? 'بطاقة' : 'آجل'}</p>
      ...
      <div class="invoice-footer">
        ...
        <div class="invoice-powered">Smart Gourmet POS System © ${new Date().getFullYear()}</div>
      </div>
