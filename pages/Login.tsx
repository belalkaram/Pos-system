...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 font-cairo">
      ...
      <div className="bg-surface rounded-[40px] border border-white/5 w-full max-w-[480px] overflow-hidden shadow-2xl relative z-10">
        <div className="p-12 text-center">
          ...
          <h2 className="text-4xl font-black text-white mb-2 tracking-tight">برنامج المحاسب</h2>
        ...
        <form onSubmit={handleLogin} className="px-12 pb-12 space-y-6">
          ...
          <button
            type='button'
            onClick={() => (window as any).ipcRenderer?.invoke('open-data-folder')}
            className="w-full text-[10px] text-blue-500 hover:text-blue-400 mt-2 opacity-50 hover:opacity-100 transition-opacity"
          >
            فتح مجلد البيانات (للصيانة)
          </button>
        </form>
      </div>
    </div>
