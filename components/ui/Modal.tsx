  ...
  return (
    <ModalContext.Provider value={{ onClose }}>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
        ...
        <div className="bg-surface rounded-[32px] border border-cardAccent w-full max-w-md shadow-2xl relative z-10 overflow-hidden flex flex-col animate-in zoom-in duration-300">
          {children}
        </div>
      </div>
